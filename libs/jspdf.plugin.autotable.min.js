...
! function (t, e) {
	...
	return function (t) {
		...
		Object.defineProperty(e, "__esModule", {
			...
			return "object" == typeof t ? ("number" == typeof t.vertical && (t.top = t.vertical, t.bottom = t.vertical), "number" == typeof t.horizontal &&
		...
		e.HtmlRowInput = i, e.defaultStyles = function (t) {
			return {
				font: "helvetica",
				fontStyle: "normal",
				overflow: "linebreak",
		...
		var o = {},
			r = function () {
				...
				return t.setDefaults = function (t, e) {
					void 0 === e && (e = null), e ? e.__autoTableDocumentDefaults = t : o = t
					...
					if (this.jsPDFDocument.setFont(s, a), e.fontSize && this.jsPDFDocument.setFontSize(e.fontSize), !n) {
						...
						d && (o = this.jsPDFDocument).setFillColor.apply(o, d), (d = t.unifyColor(e.textColor)) && (r = this.jsPDFDocument).setTextColor
							.apply(r, d), (d = t.unifyColor(e.lineColor)) && (i = this.jsPDFDocument).setDrawColor.apply(i, d), "number" == typeof e.lineWidth &&
		...
		function i(t, e, n, i, a, s) {
			for (var u = new r.HtmlRowInput(i), d = 0; d < i.cells.length; d++) {
				var c = i.cells[d],
					h = n.getComputedStyle(c);
				if (a || "none" !== h.display) {
					var f = void 0;
					s && (f = o.parseCss(t, c, e, h, n)), u.push({
						rowSpan: c.rowSpan,
						colSpan: c.colSpan,
						styles: f,
						_element: c,
		...
		e.parseHtml = function (t, e, n, o, r) {
			...
			for (var p = 0; p < s.rows.length; p++) {
				var g = s.rows[p],
					y = null === (a = null === (l = null == g ? void 0 : g.parentElement) || void 0 === l ? void 0 : l.tagName) || void 0 === a ?
					void 0 : a.toLowerCase(),
					v = i(u, d, n, g, o, r);
				v && ("thead" === y ? c.push(v) : "tfoot" === y ? f.push(v) : h.push(v))
			}
			return {
				head: c,
				body: h,
		...
		Object.defineProperty(e, "__esModule", {
			...
			var i = r.internal.scaleFactor,
				...
				a = "",
				s = 1;
			if ("middle" !== o.valign && "bottom" !== o.valign && "center" !== o.halign && "right" !== o.halign || (s = (a = "string" ==
					typeof t ? t.split(/\r\n|\r|\n/g) : t).length || 1), n += l * (2 - 1.15), "middle" === o.valign ? n -= s / 2 * l * 1.15 :
				"bottom" === o.valign && (n -= s * l * 1.15), "center" === o.halign || "right" === o.halign) {
				var u = l;
				if ("center" === o.halign && (u *= .5), a && s >= 1) {
					for (var d = 0; d < a.length; d++) r.text(a[d], e - r.getStringUnitWidth(a[d]) * u, n), n += 1.15 * l;
					return r
				}
		...
		function s(t, e, n) {
			...
			return Object.keys(o).filter((function (t) {
				...
				var e, n = 1;
				"object" != typeof (e = Array.isArray(o) ? o[parseInt(t)] : o[t]) || Array.isArray(e) || (n = (null == e ? void 0 : e.colSpan) ||
					1);
				for (var i = 0; i < n; i++) {
					var l = {
			...
			var f = function (t, e, n) {
				...
				p = function (t, e, n) {
					for (var o = {
						...
						var l = i[r];
						l.didParseCell && o.didParseCell.push(l.didParseCell), l.willDrawCell && o.willDrawCell.push(l.willDrawCell), l.didDrawCell &&
							o.didDrawCell.push(l.didDrawCell), l.didDrawPage && o.didDrawPage.push(l.didDrawPage)
					}
					return o
				}(d, u, e),
				g = function (t, e) {
					var n, o, r, l, a, s, u, d, c, h, f, p, g = i.parseSpacing(e.margin, 40 / t.scaleFactor()),
					...
					return {
						includeHiddenHtml: null !== (a = e.includeHiddenHtml) && void 0 !== a && a,
						useCss: v,
						theme: m,
						startY: y,
						margin: g,
						pageBreak: null !== (s = e.pageBreak) && void 0 !== s ? s : "auto",
						rowPageBreak: null !== (u = e.rowPageBreak) && void 0 !== u ? u : "auto",
						tableWidth: null !== (d = e.tableWidth) && void 0 !== d ? d : "auto",
						showHead: p,
						showFoot: f,
						tableLineWidth: null !== (c = e.tableLineWidth) && void 0 !== c ? c : 0,
						tableLineColor: null !== (h = e.tableLineColor) && void 0 !== h ? h : 200
					}
				}(n, h),
				y = function (t, e, n) {
					var r = e.head || [],
			...
			for (var i = 0, l = e.columns; i < l.length; i++) {
				...
				if (u)
					if (t.applyStyles(u.styles), u.x = o.x, u.y = o.y, !1 !== e.callCellHooks(t, e.hooks.willDrawCell, u, n, a, o)) {
						var d = u.styles,
							c = r.getFillStyle(d.lineWidth, d.fillColor);
						c && t.rect(u.x, o.y, u.width, u.height, c);
						var h = u.getTextPos();
						s.default(u.text, h.x, h.y, {
		...
		function c(t, e, n, o) {
			t.applyStyles(t.userStyles), "everyPage" === e.settings.showFoot && e.foot.forEach((function (n) {
				return d(t, e, n, o)
			})), e.callEndPageHooks(t, o);
			var i = e.settings.margin;
			r.addTableBorder(t, e, n, o), h(t), e.pageNumber++, e.pageCount++, o.x = i.left, o.y = i.top, "everyPage" === e.settings.showHead &&
		...
		e.drawTable = function (t, e) {
			var n = e.settings,
				...
				g = o + s.bottom + p;
			"avoid" === n.pageBreak && (g += e.allRows().reduce((function (t, e) {
				return t + e.height
			}), 0));
			var y = new l.DocHandler(t);
			("always" === n.pageBreak || null != n.startY && g > y.pageSize().height) && (h(y), f.y = s.top);
			var v = a.assign({}, f);
			e.startPageNumber = y.pageNumber(), y.applyStyles(y.userStyles), "firstPage" !== n.showHead && "everyPage" !== n.showHead || e.head
				.forEach((function (t) {
					return d(y, e, t, f)
					...
					! function t(e, n, o, r, l, s) {
						...
						if (o.canEntireRowFit(h, n.columns)) d(e, n, o, s);
								...
								var s = e.getMinimumRowHeight(o.columns, t),
									u = s < n;
								if (s > a) return console.error("Will not be able to print row " + e.index +
									" correctly since it's minimum height is larger than page height"), !0;
								if (!u) return !1;
								var d = e.hasRowSpan(o.columns);
								if (e.getMaxCellHeight(o.columns) > a) return d && console.error("The content of row " + e.index +
							...
							var f = function (t, e, n, o) {
								...
								for (var l = 0, s = 0, d = n.columns; s < d.length; s++) {
									var c = d[s];
									if (m = t.cells[c.index]) {
										Array.isArray(m.text) || (m.text = [m.text]);
										var h = new i.Cell(m.raw, m.styles, m.section);
										(h = a.assign(h, m)).text = [];
										var f = u(m, e, o);
										m.text.length > f && (h.text = m.text.splice(f, m.text.length));
										var p = o.scaleFactor();
										m.contentHeight = m.getContentHeight(p), m.contentHeight >= e && (m.contentHeight = e, h.styles.minCellHeight -= e), m.contentHeight >
											t.height && (t.height = m.contentHeight), h.contentHeight = h.getContentHeight(p), h.contentHeight > l && (l = h.contentHeight),
											r[c.index] = h
									}
								}
								...
								for (var y = 0, v = n.columns; y < v.length; y++) {
									var m;
									c = v[y];
									(h = g.cells[c.index]) && (h.height = g.height), (m = t.cells[c.index]) && (m.height = t.height)
								}
								return g
							}(o, h, n, e);
							d(e, n, o, s), c(e, n, l, s), t(e, n, f, r, l, s)
						} else c(e, n, l, s), t(e, n, o, r, l, s)
					}(y, e, t, o, v, f)
				})), y.applyStyles(y.userStyles), "lastPage" !== n.showFoot && "everyPage" !== n.showFoot || e.foot.forEach((function (t) {
					return d(y, e, t, f)
				})), r.addTableBorder(y, e, v, f), e.callEndPageHooks(y, f), e.finalY = f.y, t.lastAutoTable = e, t.previousAutoTable = e, t.autoTable &&
				(t.autoTable.previous = e), y.applyStyles(y.userStyles)
		}, e.addPage = c
	}, function (t, e, n) {
		"use strict";
		Object.defineProperty(e, "__esModule", {
		...
		var o = n(1),
			...
			l = function () {
				function t(t, e) {
					this.pageNumber = 1, this.pageCount = 1, this.id = t.id, this.settings = t.settings, this.styles = t.styles, this.hooks = t.hooks,
						this.columns = e.columns, this.head = e.head, this.body = e.body, this.foot = e.foot
				}
		...
		var a = function () {
			function t(t, e, n, r, i) {
				void 0 === i && (i = !1), this.height = 0, this.raw = t, t instanceof o.HtmlRowInput && (this.raw = t._element, this.element = t._element),
					this.index = e, this.section = n, this.cells = r, this.spansMultiplePages = i
			}
		...
		var s = function () {
			function t(t, e, n) {
				var o, r;
				this.contentHeight = 0, this.contentWidth = 0, this.wrappedWidth = 0, this.minReadableWidth = 0, this.minWidth = 0, this.width =
					0, this.height = 0, this.x = 0, this.y = 0, this.styles = e, this.section = n, this.raw = t;
				var i = t;
				null == t || "object" != typeof t || Array.isArray(t) ? (this.rowSpan = 1, this.colSpan = 1) : (this.rowSpan = t.rowSpan || 1,
					this.colSpan = t.colSpan || 1, i = null !== (r = null !== (o = t.content) && void 0 !== o ? o : t.title) && void 0 !== r ? r :
					t, t._element && (this.raw = t._element));
				var l = null != i ? "" + i : "";
				this.text = l.split(/\r\n|\r|\n/g)
			}
			return t.prototype.getTextPos = function () {
				...
				var e = (Array.isArray(this.text) ? this.text.length : 1) * (this.styles.fontSize / t * o.FONT_ROW_RATIO) + this.padding(
					"vertical");
		...
		var u = function () {
			function t(t, e, n) {
				this.wrappedWidth = 0, this.minReadableWidth = 0, this.minWidth = 0, this.width = 0, this.dataKey = t, this.raw = e, this.index =
					n
			}
		...
		function s(t, e, n, o, i, l) {
			...
			return e.map((function (e, s) {
				for (var u = 0, c = {}, h = 0, f = 0, p = 0, g = n; p < g.length; p++) {
					var y = g[p];
					if (null == a[y.index] || 0 === a[y.index].left)
						if (0 === f) {
							var v = void 0,
								m = {};
							"object" != typeof (v = Array.isArray(e) ? e[y.index - h - u] : e[y.dataKey]) || Array.isArray(v) || (m = (null == v ? void 0 :
								v.styles) || {});
							var b = d(t, y, s, i, o, l, m),
								w = new r.Cell(v, b, t);
							c[y.dataKey] = w, c[y.index] = w, f = w.colSpan - 1, a[y.index] = {
								left: w.rowSpan - 1,
								times: f
							}
						} else f--, h++;
		...
		function d(t, e, n, o, r, i, s) {
			...
			var c = a.assign({}, d.table, d[t], r.styles, u),
				h = r.columnStyles[e.dataKey] || r.columnStyles[e.index] || {},
				f = "body" === t ? h : {},
					...
					var n = t.content,
						o = function (t) {
							return t.map((function (t, e) {
								var n, o, i;
								return i = "object" == typeof t && null !== (o = null !== (n = t.dataKey) && void 0 !== n ? n : t.key) && void 0 !== o ? o :
									e, new r.Column(i, t, e)
							}))
						}(n.columns);
					if (0 === n.head.length) {
		...
		e.default = function (t) {
			t.API.autoTable = function () {
				...
				1 === e.length ? t = e[0] : (console.error("Use of deprecated autoTable initiation"), (t = e[2] || {}).columns = e[0], t.body =
					e[1]);
				var o = l.parseInput(this, t),
					r = s.createTable(this, o);
				return a.drawTable(this, r), this
			}, t.API.lastAutoTable = !1, t.API.previousAutoTable = !1, t.API.autoTable.previous = !1, t.API.autoTableText = function (t, e, n,
				o) {
				...
				if (void 0 === e && (e = !1), "undefined" == typeof window) return console.error(
					"Cannot run autoTableHtmlToJson in non browser environment"), null;
				...
				return console.error(
						"Use of deprecated function: autoTableAddPageContent. Use jsPDF.autoTableSetDefaults({didDrawPage: () => {}}) instead."), t.API
					.autoTable.globalDefaults || (t.API.autoTable.globalDefaults = {}), t.API.autoTable.globalDefaults.addPageContent = e, this
		...
		function r(t, e) {
			var n = function t(e, n) {
				var o = n(e);
				return "rgba(0, 0, 0, 0)" === o || "transparent" === o || "initial" === o || "inherit" === o ? null == e.parentElement ? null : t(
					e.parentElement, n) : o
			}(t, e);
			if (!n) return null;
		...
		e.parseCss = function (t, e, n, i, l) {
			...
			null != s && (a.fillColor = s), null != (s = r(e, (function (t) {
				return l.getComputedStyle(t).color
			}))) && (a.textColor = s), null != (s = r(e, (function (t) {
			...
			var c = ["left", "right", "center", "justify"]; - 1 !== c.indexOf(i.textAlign) && (a.halign = i.textAlign), -1 !== (c = ["middle",
				"bottom", "top"
			]).indexOf(i.verticalAlign) && (a.valign = i.verticalAlign);
			var h = parseInt(i.fontSize || "");
			isNaN(h) || (a.fontSize = h / (96 / 72));
			var f = function (t) {
				var e = "";
		...
		function o(t) {
			t.rowHeight ? (console.error("Use of deprecated style rowHeight. It is renamed to minCellHeight."), t.minCellHeight || (t.minCellHeight =
				t.rowHeight)) : t.columnWidth && (console.error("Use of deprecated style columnWidth. It is renamed to cellWidth."), t.cellWidth ||
				(t.cellWidth = t.columnWidth))
		}
		Object.defineProperty(e, "__esModule", {
			value: !0
		}), e.default = function (t, e, n, r) {
			for (var i = function (e) {
					e && "object" != typeof e && console.error("The options parameter should be of type object, is: " + typeof e), void 0 !== e.extendWidth &&
						(e.tableWidth = e.extendWidth ? "auto" : "wrap", console.error(
							"Use of deprecated option: extendWidth, use tableWidth instead.")), void 0 !== e.margins && (void 0 === e.margin && (e.margin =
							e.margins), console.error("Use of deprecated option: margins, use margin instead.")), e.startY && "number" != typeof e.startY &&
						(console.error("Invalid value for startY option", e.startY), delete e.startY), !e.didDrawPage && (e.afterPageContent || e.beforePageContent ||
							e.afterPageAdd) && (console.error(
								"The afterPageContent, beforePageContent and afterPageAdd hooks are deprecated. Use didDrawPage instead"), e.didDrawPage =
							function (n) {
								t.applyStyles(t.userStyles), e.beforePageContent && e.beforePageContent(n), t.applyStyles(t.userStyles), e.afterPageContent &&
									e.afterPageContent(n), t.applyStyles(t.userStyles), e.afterPageAdd && n.pageNumber > 1 && n.afterPageAdd(n), t.applyStyles(
										t.userStyles)
							...
							void 0 !== e[n] && (void 0 === e.styles[o] && (e.styles[o] = e[n]), console.error("Use of deprecated option: " + n +
								", use the style " + o + " instead."))
						}));
					for (var n = 0, r = ["styles", "bodyStyles", "headStyles", "footStyles"]; n < r.length; n++) {
						o(e[r[n]] || {})
					}
					for (var i = e.columnStyles || {}, l = 0, a = Object.keys(i); l < a.length; l++) {
						o(i[a[l]] || {})
					}
				}, l = 0, a = [e, n, r]; l < a.length; l++) {
				i(a[l])
			}
		}
	}, function (t, e, n) {
		...
		var i = function (t, e, n) {
			this.table = e, this.pageNumber = e.pageNumber, this.pageCount = this.pageNumber, this.settings = e.settings, this.cursor = n,
		...
		function r(t, e, n) {
			for (var o = e, i = t.reduce((function (t, e) {
					return t + e.wrappedWidth
				}), 0), l = 0; l < t.length; l++) {
				var a = t[l],
		...
		e.calculateWidths = function (t, e) {
				...
				e.allRows().forEach((function (r) {
					for (var i = 0, l = e.columns; i < l.length; i++) {
						...
						if (s) {
							...
							var c = o.getStringWidth(s.text.join(" ").split(/\s+/), s.styles, t);
							if (s.minReadableWidth = c + s.padding("horizontal"), "number" == typeof s.styles.cellWidth) s.minWidth = s.styles.cellWidth,
								s.wrappedWidth = s.styles.cellWidth;
							else if ("wrap" === s.styles.cellWidth) s.minWidth = s.contentWidth, s.wrappedWidth = s.contentWidth;
							else {
								var h = 10 / n;
								s.minWidth = s.styles.minCellWidth || h, s.wrappedWidth = s.contentWidth, s.minWidth > s.wrappedWidth && (s.wrappedWidth =
									s.minWidth)
							}
						}
					}
					...
					for (var n = 0, o = e.columns; n < o.length; n++) {
						var r = o[n],
							i = t.cells[r.index];
						if (i && 1 === i.colSpan) r.wrappedWidth = Math.max(r.wrappedWidth, i.wrappedWidth), r.minWidth = Math.max(r.minWidth, i.minWidth),
			...
			a && (a = r(n, a, (function (t) {
					return Math.max(t.minReadableWidth, t.minWidth)
				}))), a && (a = r(n, a, (function (t) {
					return t.minWidth
				}))), (a = Math.abs(a)) > .1 / t.scaleFactor() && (a = a < 1 ? a : Math.round(a), console.error("Of the table content, " + a +
					...
					for (var n = {
						...
						for (var l = r[o], a = 0, s = t.columns; a < s.length; a++) {
							...
							if (d) {
								...
								var c = d.width - d.padding("horizontal");
								"linebreak" === d.styles.overflow ? d.text = e.splitTextToSize(d.text, c + 1 / e.scaleFactor(), {
										fontSize: d.styles.fontSize
									}) : "ellipsize" === d.styles.overflow ? d.text = i(d.text, c, d.styles, e, "...") : "hidden" === d.styles.overflow ? d.text =
									i(d.text, c, d.styles, e, "") : "function" == typeof d.styles.overflow && (d.text = d.styles.overflow(d.text, c)), d.contentHeight =
									d.getContentHeight(e.scaleFactor());
								var h = d.contentHeight / d.rowSpan;
								d.rowSpan > 1 && n.count * n.height < h * d.rowSpan ? n = {
									height: h,
									count: d.rowSpan
								} : n && n.count > 0 && n.height > h && (h = n.height), h > l.height && (l.height = h)
							}
						}
						n.count--
					}
