sap.ui.define([
	...
	return Controller.extend("stipAdmin.stipAdmin.controller.EffettuaReale", {

		onInit: function () {

			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			this.oRouter.getRoute("EffettuaReale").attachPatternMatched(this._onObjectMatched, this);
		},
		...
		_executeRead: async function (TYPE) {
			...
			var oDataIn = await this._getHanaData('/VI_CONSUNTIVAZIONE_REALESet', oFilter);
		...
		_UpadteHanaData: function (ID, payload) {
			...
			return new Promise(
				function (resolve, reject) {
					...
					oBaseModel.update("/CONSUNTIVISET(ID_CONSUNTIVO=" + ID + ")", payload, {
						groupId: "UpTestata",
					});
		...
		_callXsjsScript: function (obj) {
			...
			var jurl = "/HANAMDC/STIP/STIPAdmin/services/elaboraConsuntivazioneReale_new.xsjs";
			jQuery.ajax({
				url: jurl,
				async: true,
				TYPE: 'POST',
		...
		_buildPayload: async function (data) {
			...
			var payload = {
				...
				DATALETTERA: this._getDataCons(data.DATALETTERA),
				DATAPAGAMENTO: this._getDataCons(data.DATAPAGAMENTO)
			}
		...
		onPressRowBtn1: function (oEvent) {
			...
			jQuery.sap.delayedCall(500, this, function () {
				...
				if (!selctedRowdata1.hasOwnProperty('DATALETTERA') || !selctedRowdata1.hasOwnProperty('DATAPAGAMENTO') || selctedRowdata1.DATALETTERA ===
					"" || selctedRowdata1.DATAPAGAMENTO === "" || selctedRowdata1.DATALETTERA === null || selctedRowdata1.DATAPAGAMENTO === null
				) {
					sap.ui.core.BusyIndicator.hide(0);
		...
		onPressRowBtn2: function (oEvent) {
			...
			jQuery.sap.delayedCall(500, this, function () {
				if (!selctedRowdata2.hasOwnProperty('DATALETTERA') || !selctedRowdata2.hasOwnProperty('DATAPAGAMENTO') || selctedRowdata2.DATALETTERA ===
					"" || selctedRowdata2.DATAPAGAMENTO === "" || selctedRowdata2.DATALETTERA === null || selctedRowdata2.DATAPAGAMENTO === null
				) {
					sap.ui.core.BusyIndicator.hide(0);
					this._showMessageBox();
				} else {
		...
		onPressRowBtn3: function (oEvent) {
			...
			jQuery.sap.delayedCall(500, this, function () {
				if (!selctedRowdata3.hasOwnProperty('DATALETTERA') || !selctedRowdata3.hasOwnProperty('DATAPAGAMENTO') || selctedRowdata3.DATALETTERA ===
					"" || selctedRowdata3.DATAPAGAMENTO === "" || selctedRowdata3.DATALETTERA === null || selctedRowdata3.DATAPAGAMENTO === null
				) {
					sap.ui.core.BusyIndicator.hide(0);
					this._showMessageBox();
				} else {
		...
		onPressRowBtn4: function (oEvent) {
			...
			jQuery.sap.delayedCall(500, this, function () {
				if (!selctedRowdata4.hasOwnProperty('DATALETTERA') || !selctedRowdata4.hasOwnProperty('DATAPAGAMENTO') || selctedRowdata4.DATALETTERA ===
					"" || selctedRowdata4.DATAPAGAMENTO === "" || selctedRowdata4.DATALETTERA === null || selctedRowdata4.DATAPAGAMENTO === null
				) {
					sap.ui.core.BusyIndicator.hide(0);
					this._showMessageBox();
				} else {
