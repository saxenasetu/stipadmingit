sap.ui.define(["sap/ui/core/mvc/Controller", "stipAdmin/stipAdmin/util/Formatter",
	...
	var oMainModel = new sap.ui.model.json.JSONModel();
	var idCurve = "";
	return Controller.extend("stipAdmin.stipAdmin.controller.modDiscretaRapportoPercentuale", {
		/******************** onInit method is called upon initialization of the View. The controller can perform its internal setup in this hook ********************************************/
		onInit: function () {
			this.getOwnerComponent().getRouter().getRoute("modDiscretaRapportoPercentuale").attachPatternMatched(this._onObjectMatched, this);
		},
...
*/
		...
		showCurveTitle: function (descrCurve) {
			debugger
			...
			oVizFrame.setVizProperties({
				...
				title: {
					...
					//	text: descrCurve + " - tipo curva Discreta/Rapporto Percentuale",
					text: descrCurve,
					visible: true
				}
			});
		...
		sendCurveDMSfile: function () {
			...
			var filenameTXT = "CURVA--DiscretaRapportoPercentuale--" + idCurve + ".txt";
